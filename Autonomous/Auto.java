...
public abstract class Auto extends LinearOpMode {
    ...
    private Servo leftClaw, rightClaw, capStick;
...
//                slide.setPower(0);
    ...
    public void move(double targetHeading, double power, int inches, String direction) throws InterruptedException {
        ...
        int ticks = (int)(Math.abs(inches)/DEADWHEEL_INCHES_OVER_TICKS); //how many ticks robot will travel
