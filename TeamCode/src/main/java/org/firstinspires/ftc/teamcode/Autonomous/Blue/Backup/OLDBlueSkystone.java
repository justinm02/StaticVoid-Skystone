...
//
//
//@Autonomous(name = "OLDBlueSkystone", group = "Autonomous")
//@Disabled
//public class OLDBlueSkystone extends Auto {
//
...
//
//            move(180, getPlatform-9, 0, .725, "straight");
//            extendVerticalLift();
//            extendHorizontalSlide();
//            releaseBlock();
//            move(180, 3, 180, .5, "straight");
//            retractVerticalLift();
//            move(180, 4, 180, .5, "straight");
//
//            /*PIDTurn(90, 1);
