...
public class Test extends LinearOpMode {
    ...
    private static float[] midPos = {5.5f/8f+offsetX, 3f/8f+offsetY};//0 = col, 1 = row
    private static float[] leftPos = {3.5f/8f+offsetX, 3f/8f+offsetY};
    private static float[] rightPos = {7.5f/8f+offsetX, 3f/8f+offsetY};
