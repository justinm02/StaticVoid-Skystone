...
public class Test extends LinearOpMode {
    ...
    private static float[] midPos = {3.35f/8f+offsetX, 4.65f/8f+offsetY};//0 = col, 1 = row
    private static float[] leftPos = {1.35f/8f+offsetX, 4.65f/8f+offsetY};
    private static float[] rightPos = {5.35f/8f+offsetX, 4.65f/8f+offsetY};
